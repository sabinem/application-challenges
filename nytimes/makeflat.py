...
def make_flat_structure(structure):
    ...
    - if the structure is a list or dict, a list of tuples is
    produced: struct_items can be [(k,v) for (k,v) in structure.items()]
    if the struture is a dict
    or [('0', l[0]), ('1', l(1)), ...] if the struture is a list
    ...
    by using an Ordered Dict to flatten the structure, order of values is
    retained, that is especially useful for flattening lists.
    """
